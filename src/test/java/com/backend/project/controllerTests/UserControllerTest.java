...
public class UserControllerTest {
    ...
    @BeforeEach
    public void setUp() {
        userDto = new UserDto("jsmith", "John", "Smith", "john@example.com", null, "Mr.", "USA");
    ...
    @Test
    public void updateUser_Success_ReturnsUpdatedUserDto() throws InvalidToken, NotAllowedException {
    ...
    @Test
    public void updateUser_InvalidToken_ReturnsUnauthorized() throws InvalidToken, NotAllowedException {
    ...
    @Test
    public void updateUser_NotAllowed_ReturnsForbidden() throws NotAllowedException, InvalidToken {
        when(userService.updateUser(eq("jsmith"), any(UserPatchDto.class), eq(request)))
